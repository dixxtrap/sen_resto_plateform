...
import { DeliverResendCode } from "./widget/deliver_resend_code"

export const DeliverList = () => {
    const deliver=deliverApi.useGetQuery("")
    return (
     <TablePagination title="Livreur" {...deliver} createPath="/deliver/create"  th={['Nom','Phone', 'Immatriculation','Adresse', '']} trs={<>
