        ...
        {order.products.map((orderProduct) => (
          <div className="flex flex-col  justify-between w-full">
            <div className="flex  flex-col ">
              <OrderDetailsItem
                label={orderProduct.productHistory.product.name}
                value={`${orderProduct.productHistory.price} ${TextConstant.Currency}`}
              />
              <OrderDetailsItem
                label={TextConstant.quantity}
            ...
            <OrderDetailsItem
              ...
              magnify
              value={`${
                orderProduct.productHistory.price * orderProduct.quantity
              } ${TextConstant.Currency}`}
            />
          </div>
        ))}
      </div>
