...
export const Story = () => {
 ...
 const company=storyGroup.data?.data[current!]?.partner!;
  ...
  return (
    <>
<Modal  closeOnClickOutside styles={{body:{borderRadius:20, overflow:"hidden"},root:{borderRadius:20, overflow:"hidden"}, content:{borderRadius:20, overflow:"hidden"}}} withCloseButton={false} radius={100} classNames={{content:'p-0 m-0   ', header:"rounded-lg", body:'p-0 m-0  overflow-hidden',overlay:'backdrop-blur-md rounded-lg overflow-hidden bg-black/10' }}  size={"md"} opened={opened} onClose={close  }>
  
  <div className='relative'>
  <div className='absolute z-50'>
{company&&  <div className="z-10 p-2 w-full flex items-center ">
     <div className="h-14  flex  mr-2">
      <Avatar  w={'auto'} className='my-auto' src={company.imagePath}/>
     </div>
