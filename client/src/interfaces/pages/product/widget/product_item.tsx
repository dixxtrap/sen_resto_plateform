      ...
      <div
        ...
        >
          ...
          <div className='flex gap-3'>
            {
        product.reduction!=null && product.reduction>0&& <span className='title3 line-through  decoration-2 text-gray-500'> {product.price} </span>

            }
          <span className='title3  text-primary-300'> {Math.fround(product.price!*(1-product.reduction!/100))} F CFA</span>
          </div>
